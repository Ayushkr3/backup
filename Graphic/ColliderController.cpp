...
//					BoxCollider* b1 = nullptr;
//					BoxCollider* b2 = nullptr;
//					for (auto& o : *ObjectToCheckWith[k]->GetProperties()) {
//						if (dynamic_cast<BoxCollider*>(o) != nullptr) {
//							b1 = (dynamic_cast<BoxCollider*>(o));
//						}
//					}
//					for (auto& o : *Node->objects[l]->GetProperties()) {
//						if (dynamic_cast<BoxCollider*>(o) != nullptr) {
//							b2 = (dynamic_cast<BoxCollider*>(o));
//						}
//					}
//					GlobalCollide = b1->CheckCollision(*b2) && b2->CheckCollision(*b1);
...
//					BoxCollider* b1 = nullptr;
//					BoxCollider* b2 = nullptr;
//					for (auto& o : *Node->objects[i]->GetProperties()) {
//						if (dynamic_cast<BoxCollider*>(o) != nullptr) {
//							b1 = (dynamic_cast<BoxCollider*>(o));
//						}
//					}
//					for (auto& o : *Node->objects[j]->GetProperties()) {
//						if (dynamic_cast<BoxCollider*>(o) != nullptr) {
//							b2 = (dynamic_cast<BoxCollider*>(o));
//						}
//					}
...
//					BoxCollider* b1 = nullptr;
//					BoxCollider* b2 = nullptr;
//					for (auto& o : *Node->objects[0]->GetProperties()) {
//						if (dynamic_cast<BoxCollider*>(o) != nullptr) {
//							b1 = (dynamic_cast<BoxCollider*>(o));
//						}
//					}
