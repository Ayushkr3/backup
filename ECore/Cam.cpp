...
XMVECTOR Camera::ProjectRayCast() {
	float xNDC = (2.0f * InputManager::GetInputDevices()->Ms->MouseX / 1062)-1.0f; //TODO:Change this
	float yNDC = (1.0f - 2.0f * InputManager::GetInputDevices()->Ms->MouseY / 584);//TODO: Change this
