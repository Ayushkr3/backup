...
public:
	...
	PHYSICS_API BoxCollider(std::vector<Vertex>& vertices,std::vector<NormalPerObject> Normals,ImGuiContext* ctx = ImGui::GetCurrentContext());
...
extern "C" PHYSICS_API BoxCollider *CreateBoxCollider(std::vector<Vertex>& vertices, std::vector<NormalPerObject> Normals);
#endif